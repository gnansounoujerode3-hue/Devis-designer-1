...
export default function LandingPage() {
  ...
  const features: Array<{ t: string; d: string; i: string }> = [
    ...
    { i: '📄', t: 'PDF, image ou impression', d: 'Export PDF prêt à envoyer, PNG pour WhatsApp, ou impression directe. Le document se transmet aussi par lien de partage.' },
    ...
    { i: '🧾', t: 'TVA, acomptes, multi-devises', d: 'Taux de taxe paramétrable, acompte et notes libres sur le document, montants en franc CFA, en euros ou en dollars.' },
    { i: '💾', t: 'Sauvegarde sur l’appareil', d: 'Tout ce que vous saisissez est enregistré dans le navigateur au fil de la saisie, et vous pouvez exporter une copie JSON à réimporter plus tard sur un autre appareil.' },
    { i: '🌙', t: 'Mode sombre et raccourcis', d: 'Bascule clair/sombre conservée, raccourcis clavier pour enregistrer, dupliquer ou exporter sans quitter le clavier.' },
  ];

  const steps: Array<{ n: string; t: string; d: string }> = [
    { n: '1', t: 'Renseignez votre entreprise', d: 'Nom, activité, coordonnées, logo : l’en-tête est rempli une fois pour toutes et se retrouve sur chaque document.' },
    ...
    { n: '4', t: 'Exportez, faites signer', d: 'PDF à envoyer, lien de signature pour le client, puis conversion en facture une fois l’accord reçu.' },
  ];
